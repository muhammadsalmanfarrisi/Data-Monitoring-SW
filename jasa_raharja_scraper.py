...
def ambil_data(url, retries=3):
    ...
    cookies = {
        "XSRF-TOKEN": "%3D",
        ...
        "ceri_session": "%3D",
        "cookiesession1": "678B28C4BA1B09254D21278D87A606A5",
        "jr_cookie": "c686aabd2eea2ae0eedde6ce4a74fc67",
...
def ambil_total_bulanan_paralel(tahun):
    with ThreadPoolExecutor() as executor:
        ...
        for bulan in range(1, 13):
            ...
            end_day = monthrange(tahun, bulan)[
                1
            ]  # Mendapatkan tanggal akhir yang tepat untuk bulan tersebut
            ...
            futures.append(
                executor.submit(ambil_data, url)
            )  # Menjalankan ambil_data secara paralel
...
def ambil_total_sw_today_loket():
    ...
    total_sw_thisyear_today = (
        sum(item["jml_sw"] for item in data_thisyear[:37]) if data_thisyear else 0
    )
    ...
    total_sw_lastyear_today = (
        sum(item["jml_sw"] for item in data_lastyear[:37]) if data_lastyear else 0
    )
...
def ambil_total_bulanan_paralel_purwokerto(tahun):
    with ThreadPoolExecutor() as executor:
        ...
        for future in futures:
            result, total_jml_sw = future.result()
            bulanan_totals_purwokerto.append(
                total_jml_sw if total_jml_sw is not None else 0
            )
...
def index():
    ...
    previous_year_today = today.replace(year=today.year - 1).strftime(
        "%Y-%m-%d"
    )  # Tahun dikurangi 1
    ...
    if request.method == "POST":
        ...
        if form_type == "form1":
            ...
            kabeh_percent_change = (
                (kabeh_diff / kabeh_sw_2023) * 100 if kabeh_sw_2023 != 0 else 0
            )
            ...
            return render_template(
                ...
                kabeh_sw_2023=kabeh_sw_2023,
                kabeh_sw_2024=kabeh_sw_2024,
                kabeh_diff=kabeh_diff,
                kabeh_percent_change=kabeh_percent_change,
                total_sw_thisyear_today=total_sw_thisyear_today,
                total_sw_lastyear_today=total_sw_lastyear_today,
                today_form=today_form,
                start_date_thisyear=start_date_thisyear,
                end_date_thisyear=end_date_thisyear,
                start_date_lastyear=start_date_lastyear,
                end_date_lastyear=end_date_lastyear,
                today=today,
                previous_year_today=previous_year_today,
                ...
                tahun_start_date_2023=tahun_start_date_2023,
                tahun_start_date_2024=tahun_start_date_2024,
            )
    ...
    return render_template(
        ...
        today_form=today_form,
        total_2024=total_2024,
        tahun_start_date_2023=previous_year,
        tahun_start_date_2024=current_year,
    )


def kelompokkan_data(data_kantor):
    kelompok_mapping = {
        "SAMSAT KENDAL": ["SAMSAT KENDAL", "SAMSAT KENDAL II"],
        "SAMSAT DEMAK": [
            "SAMSAT DEMAK",
            "SAMSAT DEMAK II",
            "SAMSAT DEMAK III",
        ...
        "SAMSAT PURWODADI": [
            "SAMSAT PURWODADI",
            "SAMSAT PURWODADI II",
            "SAMSAT PATEN WIROSARI",
            "SAMSAT SEKOLAH KABUPATEN GROBOGAN",
            "SAMSAT PATEN GUBUG",
            "SAMKEL RAZIA GROBOGAN",
        ],
        "SAMSAT SALATIGA": [
            "SAMSAT SALATIGA",
            "SAMSAT KELILING SALATIGA",
            "SAMSAT KELILING SALATIGA MALAM",
        ],
        "SAMSAT UNGARAN": [
            "SAMSAT UNGARAN",
            "SAMSAT UNGARAN II",
            "SAMSAT GERAI UNGARAN",
            "SAMSAT KELILING UNGARAN II",
            "SAMSAT PATEN TENGARAN",
            "SAMSAT GERAI TUNTANG",
            "SAMSAT GERAI AMBARAWA",
        ],
        "E-SAMSAT": [
            "E-SAMSAT BPD JATENG",
            "E-SAMSAT BNI",
            "E-SAMSAT BANK MANDIRI",
            "E-SAMSAT BRI",
            "E-SAMSAT BANK CIMB NIAGA",
            "E-SAMSAT BCA",
            "LOKET E-SAMSAT KANTOR POS",
            "E-SAMSAT BPR GROBOGAN",
            "E-SAMSAT BTN",
        ...
        "SAMSAT SURAKARTA": [
            "SAMSAT SURAKARTA II",
            "SAMSAT CEPAT SURAKARTA",
            "SAMSAT MALAM SURAKARTA",
            "SAMSAT SIAGA SURAKARTA",
        ],
        "SAMSAT KLATEN": [
            "SAMSAT KLATEN",
            "SAMSAT KLATEN II",
            "SAMSAT KELILING MALAM KLATEN",
        ],
        "SAMSAT BOYOLALI": [
            "SAMSAT BOYOLALI",
            "SAMSAT BOYOLALI II",
            "SAMSAT KELILING MALAM BOYOLALI",
        ],
        "SAMSAT SRAGEN": [
            "SAMSAT SRAGEN",
            "SAMSAT KELILING SRAGEN",
            "SAMSAT KELILING MALAM SRAGEN",
            "SAMSAT PATEN TANON",
        ],
        "SAMSAT PRAMBANAN": ["SAMSAT PRAMBANAN"],
        "SAMSAT DELANGGU": ["SAMSAT DELANGGU"],
        "SAMSAT MAGELANG": [
            "SAMSAT MAGELANG",
            "SAMSAT CEPAT KOTA MAGELANG",
            "SAMSAT MALAM KOTA MAGELANG",
        ],
        "SAMSAT PURWOREJO": [
            "SAMSAT PURWOREJO",
            "SAMSAT PURWOREJO II",
            "SAMSAT PATEN KUTOARJO",
        ],
        "SAMSAT KEBUMEN": [
            "SAMSAT KEBUMEN",
            "SAMSAT KEBUMEN II",
            "SAMSAT CEPAT GOMBONG",
        ],
        "SAMSAT TEMANGGUNG": ["SAMSAT TEMANGGUNG", "SAMSAT TEMANGGUNG II"],
        "SAMSAT WONOSOBO": ["SAMSAT WONOSOBO", "SAMSAT WONOSOBO II"],
        "SAMSAT MUNGKID": [
            "SAMSAT MUNGKID",
            "SAMSAT MUNGKID II",
            "SAMSAT MALAM KABUPATEN MAGELANG",
        ],
        "SAMSAT BAGELEN": ["SAMSAT BAGELEN"],
        "SAMSAT PURWOKERTO": [
            "SAMSAT PURWOKERTO",
            "SAMSAT PURWOKERTO II",
            "SAMSAT CEPAT PURWOKERTO",
            "SAMSAT RITA MALL PURWOKERTO MA",
        ],
        "SAMSAT PURBALINGGA": [
            "SAMSAT PURBALINGGA",
            "SAMSAT PURBALINGGA II",
            "SAMSAT PATEN BUKATEJA",
        ],
        "SAMSAT BANJARNEGARA": [
            "SAMSAT BANJARNEGARA",
            "SAMSAT KELILING BANJARNEGARA",
            "SAMSAT KELILING BANJARNEGARA II",
            "SAMSAT GERAI SWALAYAN PELITA",
        ],
        "SAMSAT MAJENANG": ["SAMSAT MAJENANG"],
        "SAMSAT CILACAP": [
            "SAMSAT CILACAP",
            "SAMSAT CILACAP II",
            "SAMSAT KELILING CILACAP MALAM",
        ],
        "SAMSAT WANGON": ["SAMSAT WANGON", "SAMSAT KELILING WANGON"],
        "SAMSAT PEKALONGAN": [
            "SAMSAT PEKALONGAN",
            "SAMSAT CEPAT PEKALONGAN",
            "SAMSAT KELILING KOTA PEKALONGAN",
        ],
        "SAMSAT PEMALANG": [
            "SAMSAT PEMALANG",
            "SAMSAT PEKALONGAN II",
            "SAMSAT PEMALANG MALAM",
        ],
        "SAMSAT TEGAL": ["SAMSAT TEGAL", "SAMSAT KELILING TEGAL"],
        "SAMSAT BREBES": ["SAMSAT BREBES", "SAMSAT PATEN LARANGAN"],
        "SAMSAT BATANG": [
            "SAMSAT BATANG",
            "SAMSAT BATANG II",
            "SAMSAT PATEN LIMPUNG",
            "SAMSAT KELILING BATANG MALAM",
        ],
        "SAMSAT KAJEN": ["SAMSAT KAJEN", "SAMSAT KAJEN II"],
        "SAMSAT SLAWI": ["SAMSAT SLAWI", "SAMSAT KELILING SLAWI"],
        "SAMSAT BUMIAYU": ["SAMSAT BUMIAYU"],
        "SAMSAT TANJUNG": ["SAMSAT TANJUNG"],
        "SAMSAT PATI": [
            "SAMSAT PATI",
            "SAMSAT PATI II",
            "SAMSAT CEPAT PATI",
            "SAMSAT KELILING PATI II",
            "SAMSAT SAJAK PATI",
        ],
        "SAMSAT KUDUS": ["SAMSAT KUDUS", "SAMSAT KELILING KUDUS"],
        "SAMSAT JEPARA": [
            "SAMSAT JEPARA",
            "SAMSAT KARIMUNJAWA",
            "SAMSAT JEPARA II",
        ...
        "SAMSAT REMBANG": [
            "SAMSAT REMBANG",
            "SAMSAT REMBANG II",
            "SAMSAT PATEN KALIORI",
            "SAMSAT KELILING REMBANG II",
            "SAMSAT SAJAK REMBANG",
        ],
        "SAMSAT BLORA": [
            "SAMSAT BLORA",
            "SAMSAT BLORA II",
            "SAMSAT PATEN KUNDURAN",
            "SAMSAT PATEN RANDUBLATUNG",
        ],
        "SAMSAT CEPU": ["SAMSAT CEPU"],
        "SAMSAT SEMARANG I": [
            "SAMSAT SEMARANG I",
            "SAMSAT SEMARANG IV",
            "SAMSAT CEPAT SEMARANG I",
            "SAMSAT MALL CIPUTRA",
        ],
        "SAMSAT SEMARANG II": ["SAMSAT SEMARANG II", "SAMSAT SEMARANG V"],
        "SAMSAT SEMARANG III": [
            "SAMSAT SEMARANG III",
            "SAMSAT KELILING SEMARANG III",
            "SAMSAT UNNES",
        ],
        "SAMSAT SUKOHARJO": [
            "SAMSAT SUKOHARJO",
            "SAMSAT SUKOHARJO II",
            "SAMSAT MALL THE PARK",
            "SAMSAT GERAI SINGOPURAN",
            "SAMSAT THE PARK MALAM",
            "SAMSAT MALAM TOSERBA",
        ],
        "SAMSAT KARANGANYAR": ["SAMSAT KARANGANYAR", "SAMSAT KARANGANYAR II"],
        "SAMSAT WONOGIRI": [
            "SAMSAT WONOGIRI",
            "SAMSAT PATEN EROMOKO",
            "SAMSAT KELILING WONOGIRI",
            "SAMSAT GERAI TOKO BARU MALAM",
        ],
        "SAMSAT PURWANTORO": ["SAMSAT PURWANTORO"],
        "SAMSAT BATURETNO": ["SAMSAT BATURETNO"],
    }
...
def halaman_tertuju(kode_kantor_jr):
    ...
    bulanan_2023, total_2023 = ambil_total_bulanan_per_kantor(
        previous_year, kode_kantor_jr
    )
    bulanan_2024, total_2024 = ambil_total_bulanan_per_kantor(
        current_year, kode_kantor_jr
    )

    total_sw_thisyear_today, total_sw_lastyear_today = ambil_total_sw_today_kantor(
        kode_kantor_jr
    )
...
def halaman_loket():
    ...
    return render_template(
        "halaman_loket.html",
        data_kantor_terbatas=data_kantor_terbatas,
        start_date_2023=start_date_2023,
        bulanan_2024=bulanan_2024,
        total_2024=total_2024,
        end_date_2023=end_date_2023,
        ...
        total_2023=total_2023,
        end_date_2024=end_date_2024,
        total_jml_sw_2023_filtered=kabeh_sw_2023,
        total_jml_sw_2024_filtered=kabeh_sw_2024,
        kabeh_diff=kabeh_diff,
        kabeh_percent_change=kabeh_percent_change,
        total_sw_thisyear_today=total_sw_thisyear_today,
        total_sw_lastyear_today=total_sw_lastyear_today,
